...
async function main() {
  ...
  // Write to file for cross-referencing
  ...
  fs.writeFileSync("C:/Users/HP/htn-api/scratchpad/micro1-summaries.json", JSON.stringify(summaries, null, 2));
  console.log("Summaries written to scratchpad/micro1-summaries.json");
}
